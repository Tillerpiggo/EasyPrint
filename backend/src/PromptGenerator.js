    ...
    generate(promptType, code) {
        ...
        switch (promptType) {
            case PromptType_1.PromptType.SingleLine:
                prompt = `Add a SINGLE print statement to the following code. In one print statement, print the names and values of all variables involved, and the overall value of the expression. Respond with ONLY ONE PRINT STATEMENT and nothing else. The code: ${code}`;
                break;
