...
export class PromptGenerator {
  private customInstructions = "Only respond with code in Java and no extra characters.";//' Please rewrite the code exactly and provide only the rewritten code. Write in Java';
